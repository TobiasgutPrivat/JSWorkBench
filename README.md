...
Verm. mit Typescript + React oder so

DB: NoSQL + Vektor, serialisierung als json/dict-array-format, kein weiteres Backend (auth per DB)
...
fremde objekte als ganzes serialisieren

speichern von komischen sachen wie anonymous functions/ promises etc. nicht unterstützt

wahrscheinlich qdrant: https://qdrant.tech/documentation/quickstart/

### zusatzinfos

zu objekten müssen infos gespeichert werden, wie datentypen (inkl packages), darstellungs info, …

option1: nebenbei zugehörig zu objekt

option2: metadata in objekt hinzufügen
